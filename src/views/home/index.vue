...
<script>
    ...
    const country = ["中国", "阿富汗", "阿尔巴尼亚", "阿尔格拉", "安道尔", "安哥拉", "安圭拉",
    ...
    const eCountry = ["China", "Afghanistan", "Albania", "Algera",
    ...
    const countryCode = ["+86", "+93", "+355", "+213", "+376", "+244", "+1264",
    ...
    export default {
        ...
        methods: {
            ...
            handleCode() {
                ...
                eCountry.map((item, idx) => {
                    let index = array.indexOf(item.substr(0, 1));
